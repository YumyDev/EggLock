...
private:
	auto RenderListBoxColors( const char* Title , const char* str_id , uint32_t* current_item , CEggLockMenu::ColorItemsList_t* pList , int height_in_items , float left_padding = 75.f ) -> bool;
