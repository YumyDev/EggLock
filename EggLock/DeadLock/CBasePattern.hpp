...
public:
	...
	void UpdatePattern( const char* szPattern , uint32_t Offset = 0 , eBasePatternSearchType Type = eBasePatternSearchType::SEARCH_TYPE_NONE );
	void UpdateDll( const char* szDll );
